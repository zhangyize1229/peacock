  ...
  <div class="wm-avatar">
    ...
    <el-popover
      ...
      v-model="visible">
        ...
        <div class="drop-item" v-if="src>0" @click="()=>{visible=false;remove()}">{{t('wm.avatar.remove')}}</div>
      <el-button slot="reference" class="btn" @click="()=>{visible=!visible}"><i class="el-icon-edit el-icon--left"></i>edit</el-button>
    </el-popover>
  </div>
</template>
<script>
