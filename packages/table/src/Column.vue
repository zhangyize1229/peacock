<template>
  <div>
    <template v-for="(column, index) in columns">
      ...
      <el-table-column :key="column.prop" v-if="(column.type==='selection' || column.type==='index') && show(column) " v-bind="column"></el-table-column>

      <el-table-column v-else-if="column.type === 'expand' && show(column)" type="expand" :key="column.prop" v-bind="column" >
