  ...
  methods: {
    ...
    async handleFileUpload(file) {
      ...
      const res = await axios({
        ...
        headers: {
          "Blade-Auth": "bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..-7fo_dYQFBowlkKImp2OD3cgZjad8jKo2tZ0KZ7gntSsO82nKb7sLBVGy4mC3vahc9K5FpYQWVEeWBPDopqZlg"
       },
        data: formData,
      });
      const {
