  ...
  methods: {
    ...
    async handleFileUpload(file) {
      ...
      const res = await axios({
        ...
        headers: {
          "Blade-Auth":
            "bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..PD-dxtSqc3p8Ge9MPAtnFww3vLsPfznz25mLe3JjKf62p3k6fmnsGmicEj-uvmdxoFTpagVpnH6UeZjd-YQVnQ",
        },
        data: formData,
      });
      const {
